...
const names = [
    {
        ...
        button: "Start 15-Day Trial",
        profiles: '4 Therapy Sessions',
        posts: 'In-Clinic Visits Only',
        templates: "30 Mins Each Session",
        view: "No Equipment Support",
    ...
    },
    {
        ...
        user: 'per user, per month',
        button: "Start 15-Day Trial",
        profiles: '8 Therapy Sessions',
        posts: 'Includes 2 Home Visits',
        templates: "45 Mins Each Session",
        view: "Includes Exercise Equipment",
    ...
    },
    {
        ...
        user: 'per user, per month',
        button: "Start 15-Day Trial",
        profiles: 'Unlimited Therapy Sessions',
        posts: 'Unlimited Home Visits',
        templates: "60 Mins Each Session",
        view: "Equipment + Personalized Plans",
        ...
        <div id="services-section">
            <div className='mx-auto max-w-7xl sm:py-20 lg:px-8 my-16'>
                <h3 className='text-center text-4xl sm:text-65xl font-black'>
                    Manage All Your Physiotherapy <br /> Needs From One Place.
                </h3>
                ...
                <div className='md:flex md:justify-around mt-20'>
                    ...
                    <div className='flex gap-5 justify-center md:justify-start'>
                        <Image src="/images/manage/right.svg" alt="right-icon" width={21} height={14} />
                        <h4 className='text-lg font-semibold'>Unlimited Support</h4>
                    </div>
                    <div className='flex gap-5 justify-center md:justify-start'>
                        <Image src="/images/manage/right.svg" alt="right-icon" width={21} height={14} />
