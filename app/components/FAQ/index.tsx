                    ...
                    <Disclosure as="div" className="mt-2">
                        {({ open }) => (
                            <>
                                ...
                                <Disclosure.Panel className="px-4 pt-4 pb-2 text-base text-black font-normal opacity-50">
                                    We treat back and neck pain, joint pain, post-surgery rehab, sports injuries, arthritis, posture issues, and neurological conditions like stroke and paralysis.
                                </Disclosure.Panel>
                            </>
                        )}
                    </Disclosure>
                    ...
                    <Disclosure as="div" className="mt-2">
                        {({ open }) => (
                            <>
                                ...
                                <Disclosure.Panel className="px-4 pt-4 pb-2 text-base text-black font-normal opacity-50">
                                    Yes, we specialize in at-home physiotherapy services. A certified physiotherapist will visit your location based on your preferred time slot.
                                </Disclosure.Panel>
                            </>
                        )}
                    </Disclosure>
