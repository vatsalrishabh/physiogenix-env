...
const footer = () => {
    ...
    return (
            ...
            <div className="mx-auto max-w-2xl pt-48 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="mt-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
                    ...
                    <div className='col-span-4'>
                        <h3 className='text-white text-4xl font-semibold leading-9 mb-4 lg:mb-20'>  {process.env.NEXT_PUBLIC_BRAND_NAME||"Brand Name"}</h3>
      ...
      <Link href={process.env.NEXT_PUBLIC_SITE_URL || '#'} target="_blank">
        {process.env.NEXT_PUBLIC_SITE_NAME || 'YourBrand.com'}
      </Link>
                            </h3>
                        </div>
